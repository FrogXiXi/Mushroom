...
### cake/bases/double/formal.png
Prompt: formal double-layer cream-covered cake base, two stacked round cake layers separated by a visible butter-yellow sponge band and thin whipped-cream filling between layers; smooth whipped-cream covering continuing across layers, subtle rim highlights, gentle shadow between tiers, and a small decorative top dollop; warm off-white cream with soft pastel accents, naive childlike crayon drawing style, visible wax grain, uneven hand-colored fill, thick slightly wobbly outline, off-white paper texture, transparent background
Negative: photorealistic, 3D rendering, glossy/specular highlights, vector-clean lines, metallic shine, black background, watermark, blur
Settings: Seed=20260405, Size=2048x2048, Sampler=Euler a, Steps=30, CFG=7.0
